            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="target_kegiatan" id="target_kegiatan" class="form-control select2 @error('target_kegiatan') is-invalid @enderror" placeholder="Masukan Target" value="{{ old('target_kegiatan') }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="realisasi" id="realisasi" class="form-control select2 @error('realisasi') is-invalid @enderror" placeholder="Masukan Realisasi" value="{{ old('realisasi') }}" required>
                        @error('realisasi')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                            </span>
